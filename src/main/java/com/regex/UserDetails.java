...
public class UserDetails extends UserRegistrationRegex {
    ...
    public static void password() {
        ...
        UserRegistrationRegex.password(password);
    }
}
